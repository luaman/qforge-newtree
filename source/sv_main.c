...
SV_InitLocal (void)
{
	...
	fraglimit = Cvar_Get ("fraglimit", "0", CVAR_SERVERINFO, NULL, "Amount of frags a player must attain in order to exit the level");
	...
	hostname = Cvar_Get ("hostname", "unnamed", CVAR_SERVERINFO, NULL, "Report or sets the server name");
	...
	spawn = Cvar_Get ("spawn", "0", CVAR_SERVERINFO, NULL, "Spawn the player entity");
	watervis = Cvar_Get ("watervis", "0", CVAR_SERVERINFO, NULL, "Toggle the use of r_watervis by OpenGL clients");
	...
	sv_wateraccelerate = Cvar_Get ("sv_wateraccelerate", "10", CVAR_NONE, NULL, "Sets the water acceleration value");

	sv_allow_log = Cvar_Get ("sv_allow_log", "1", CVAR_NONE, NULL, "Allow remote logging");
	sv_allow_ping =	Cvar_Get ("sv_allow_pings", "1", CVAR_NONE, NULL, "Allow remote pings (qstat etc)");
	sv_allow_status = Cvar_Get ("sv_allow_status", "1", CVAR_NONE, NULL, "Allow remote status queries (qstat etc)");

	sv_extensions = Cvar_Get ("sv_extensions", "1", CVAR_NONE, NULL, "Use protocol extensions for QuakeForge clients");
	...
	sv_maxrate = Cvar_Get ("sv_maxrate", "0", CVAR_SERVERINFO, NULL, "Maximum allowable rate");
	...
	sv_minqfversion = Cvar_Get ("sv_minqfversion", "0", CVAR_SERVERINFO, NULL, "Minimum QF version on client");
	sv_spectatormaxspeed = Cvar_Get ("sv_spectatormaxspeed", "500", CVAR_NONE, NULL, "Sets the maximum speed a spectator can move");
	sv_stopspeed = Cvar_Get ("sv_stopspeed", "100", CVAR_NONE, NULL, "Sets the value that determines how fast the player should come to a complete stop");

	sv_timekick = Cvar_Get ("sv_timekick", "3", CVAR_SERVERINFO, NULL, "Time cheat protection");
	sv_timekick_fuzz = Cvar_Get ("sv_timekick_fuzz", "15", CVAR_NONE, NULL, "Time cheat \"fuzz factor\"");
	sv_timekick_interval = Cvar_Get ("sv_timekick_interval", "30", CVAR_NONE, NULL, "Time cheat check interval");
